...
)
{
    ...
    if (k == 0 && lane == 0)
    {
        ...
        printf(
            ...
            t_spr_total > 0 ? 100.0 * sh.t_search / t_spr_total : 0.0, sh.t_apply,
            t_spr_total > 0 ? 100.0 * sh.t_apply / t_spr_total : 0.0, sh.n_apply, sh.n_dowhile, n,
